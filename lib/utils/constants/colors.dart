...
class TColors {
  ...
  static const alterColor = Color(0xFF1C3E7B);
  ...
  static const Color txt333333 = Color(0xFF333333);
  static const Color txt666666 = Color(0xFF666666);

  // Background colors
  static const Color light = Color(0xFFF6F6F6);
  static const Color dark = Color(0xFF272727);
  static const Color primaryBackground = Color(0xFFF5F5F5);
  static const Color secondaryBackground = Color(0xFFE9EFFD);
