...
class UsersFilterDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final RxInt tempStatusId = controller.selectedStatusFilterId.value.obs;
    final RxInt tempRoleFilterId = controller.selectedRoleFilterId.value.obs;
      ...
      content: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Obx(() {
              return DropdownButtonFormField<int>(
                value: tempRoleFilterId.value,
                onChanged: (value) => tempRoleFilterId.value = value!,
                isExpanded: true,
                decoration: InputDecoration(
                  labelText: AppLocalization.of(
                    context,
                ...
                items:
                    ...
                    controller.userRolesList
                        .map(
                          (r) => DropdownMenuItem<int>(
                            value: r.id,
                            child: Text(r.nameTranslated!),
                          ),
                        )
                        .toList(),
              );
                ...
                Expanded(
                  child: TextButton(
                    onPressed: () {
                      ...
                      controller.applyFilters(-1, -1, null, null);
