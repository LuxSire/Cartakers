...
import 'package:cartakers/features/shop/screens/settings_managements/widgets/settings_management_detail_tab.dart';
...
class SettingsManagementMobileScreen extends StatelessWidget {
  const SettingsManagementMobileScreen({super.key, required this.roleExtId});
  final int roleExtId;
