...
class TenantDocumentsTab extends StatelessWidget {
    ...
    final controller = Get.put(
      DocumentController(
        contractId: int.parse(
          controllerTenant.tenantModel.value.tenantContractId.toString(),
        ),
      ),
    );
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                ...
                child: TextFormField(
                  onChanged: (query) => controller.filterDocs(query),
  ...
  Widget _buildDocumentCard(
    ...
    final fileName = THelperFunctions.extractFileName(url, 'media');
