...
import 'package:xm_frontend/features/shop/screens/tenant/dialogs/requests_filter_dialog.dart';
...
class TenantRequestsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.find<RequestController>(tag: 'tenant_requests');
