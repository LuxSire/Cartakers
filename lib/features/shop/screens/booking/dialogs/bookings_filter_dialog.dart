...
class BookingsFilterDialog extends StatelessWidget {
  const BookingsFilterDialog({super.key});
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            // Search bar for Booking Title Filter
            // TextFormField(
            //   controller: controller.searchController,
            //   onChanged: (query) => controller.filterBookings(query),
            //   decoration: InputDecoration(
            //     hintText: AppLocalization.of(
            //       context,
            //     ).translate('general_msgs.msg_search_booking'),
                ...
                Expanded(
                  child: Obx(
                    () => _buildDatePicker(
                      ...
                      () =>
                          tempStartDate.value = null, // Clear start date method
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: Obx(
                    () => _buildDatePicker(
                      ...
                      () => tempEndDate.value = null, // Clear end date method
                    ),
                  ),
                ),
              ],
            ...
            Obx(() {
              final statusMap = controller.getTranslatedBookingStatuses(
                context,
              );
