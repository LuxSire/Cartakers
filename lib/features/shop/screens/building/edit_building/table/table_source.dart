...
class BuildingUnitsRows extends DataTableSource {
  final controller = EditBuildingController.instance;

  constructor() {
    controller.loadUnitRoomList();
  }

  @override
  DataRow? getRow(int index) {
    final unit = controller.filteredBuildingUnits[index];
    return DataRow2(
      ...
      cells: [
            ...
            return DropdownButton<UnitRoomModel>(
              ...
              onChanged: (newRoom) {
                if (newRoom != null && newRoom.id != currentRoom.id) {
                  ...
                  controller.filteredBuildingUnits.refresh();
                }
              },
              items:
        ...
        DataCell(Text('${unit.tenantNames}')),
        DataCell(
          TRoundedContainer(
              ...
              Get.toNamed(Routes.unitDetails, arguments: unit)?.then((result) {
                ...
                if (result == true) {
                  ...
                  final controllerUnitDetail =
                      BuildingUnitDetailController.instance;
  ...
  @override
  int get rowCount => controller.filteredBuildingUnits.length;
