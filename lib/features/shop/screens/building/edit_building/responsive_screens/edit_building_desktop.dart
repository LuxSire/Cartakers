...
class EditBuildingDesktopScreen extends StatelessWidget {
  const EditBuildingDesktopScreen({super.key, required this.building});
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  // Left Side units
                  Expanded(flex: 2, child: BuildingUnits(building: building)),
                ],
              ),
            ],
          ),
