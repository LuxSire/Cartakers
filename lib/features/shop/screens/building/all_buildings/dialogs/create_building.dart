...
class CreateBuildingDialog extends StatelessWidget {
  const CreateBuildingDialog({super.key});
              ...
              Row(
                ...
                children: [
                  Text(
                    AppLocalization.of(
                      context,
                    ).translate('buildings_screen.lbl_new_building'),
                ...
                children: [
                  ...
                  Expanded(
                    child: Tooltip(
                      message: AppLocalization.of(
                        context,
                      ).translate('buildings_screen.tooltip_total_units'),
                      child: TextFormField(
                        controller: controller.units,
                        decoration: InputDecoration(
                          hintText: AppLocalization.of(
                            context,
                          ).translate('buildings_screen.lbl_total_units'),
                          label: Text(
                            AppLocalization.of(
                              context,
                            ).translate('buildings_screen.lbl_total_units'),
                  ...
                  Expanded(
                    child: Tooltip(
                      message: AppLocalization.of(
                        context,
                      ).translate('buildings_screen.tooltip_total_floors'),
                      child: TextFormField(
                        controller: controller.floors,
                        decoration: InputDecoration(
                          hintText: AppLocalization.of(
                            context,
                          ).translate('buildings_screen.lbl_total_floors'),
                          label: Text(
                            AppLocalization.of(
                              context,
                            ).translate('buildings_screen.lbl_total_floors'),
                ...
                return controller.loading.value
                    ...
                    : SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.submitBuilding,
                        //  onPressed: () {},
                        child: Text(
                          AppLocalization.of(
                            context,
