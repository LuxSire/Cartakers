...
class ObjectUnitContractTable extends StatelessWidget {
  const ObjectUnitContractTable({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      Visibility(
        visible: false,
        child: Text(controller.filteredObjectUnitContracts.length.toString()),
      );
      Visibility(
        visible: false,
      ...
      return TPaginatedDataTable(
        ...
        source: ObjectUnitContractsRows(),
      );
    });
  }
}
