        ...
        Get.toNamed(Routes.contractDetails, arguments: contract)?.then((
          ...
          if (result == true) {
            ...
            if (controllerContract.contractModel.value.statusId == 2 ||
              ...
              controllerUnitDetail.unit.value.userCount = 0;
              controllerUnitDetail.unit.value.userNames = '';
            ...
            onSelected: (value) async {
              if (value == 'edit') {
                ...
                if (updatedContract != null) {
                  ...
                  final index = controller.filteredObjectUnitContracts
                      .indexWhere((c) => c.id == updatedContract.id);
                  final previousContract =
                      controller.filteredObjectUnitContracts[index];
                  ...
                  if (index != -1) {
                    ...
                    debugPrint(
                      'Updated Contract: ${updatedContract.contractCode} - ${updatedContract.userNames}',
                    );
                    ...
                    if (updatedContract.statusId == 2) {
                      ...
                      if (previousContract.statusId == 1) {
                        ...
                        controller.allUsers
                            .clear(); // Clear visible users list
                      }
                      ...
                      controller.unit.update((u) {
                        ...
                        u?.userCount = updatedContract.userCount;
                        u?.updatedAt = DateTime.now();

                        u?.userNames = updatedContract.userNames;
                ...
                if (updatedResult) {
                  ...
                  if (index != -1) {
                    ...
                    controller.allUsers.clear(); // Clear visible users list
                  }
                }
                ...
                if (confirmed) {
                  ...
                  if (deleted) {
                    ...
                    controller.filteredObjectUnitContracts.removeAt(index);
                    notifyListeners();
                  }
                }
              }
