...
class UsersFilterInvitationDialog extends StatelessWidget {
  const UsersFilterInvitationDialog({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<UserInvitationController>();
